...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0), "Zero address is not a valid address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Destinatary address is the same as the onwer");

        // DONE require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, to), "Only owner or approved address can approve");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Can't mint to zero _clear address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == owner, "Sender is not the owner of the token");
        // DONE: require token is being transfered to valid address
        require(to != address(0), "Recepient can't be zero address");
        // DONE: clear approval
...
contract RealEstateToken is ERC721Metadata {
