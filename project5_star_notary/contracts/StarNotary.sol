...
contract StarNotary is ERC721Full {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((ownerTokenId1 == msg.sender) || (ownerTokenId2 == msg.sender), 'You must be the owner of one of the tokens');
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, 'You must be the owner of the start you want to transfer');
